...
export default function ProfilePage() {
  ...
  const renderStarRating = (rating: number | null) => {
    if (rating === null) return <span className="text-sm text-muted-foreground">N/A</span>;
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Next reward at 3,000 points</p>
                </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Reserved appointments</p>
                </div>
              </div>
