    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="p-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">Last 8 months</p>
        </Card>
        <Card className="p-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">Redeemable points</p>
        </Card>
      </div>
            ...
            {userData.map((user) => (
              <div key={user.id} className="flex justify-between border-b pb-3">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-muted-foreground">{user.treatment}</p>
                </div>
              </div>
            ))}
          </div>
